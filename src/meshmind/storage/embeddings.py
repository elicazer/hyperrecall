...
MeshMind keeps embeddings as raw little-endian float32 BLOBs in SQLite and does
nearest-neighbour search in numpy. This keeps a MeshMind database a single
...
model by passing an ``embed`` callable to :class:`meshmind.Mesh`.
"""
