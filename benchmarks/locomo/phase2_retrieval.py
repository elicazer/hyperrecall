...
ANSWER_PROMPT_TEMPORAL = (
    ...
    "Use ONLY the provided memory context. If the context does not contain enough "
    "information to answer, reply exactly: 'I don't know.' "
    "A bracketed timestamp is the date of that utterance. Resolve relative expressions "
    "such as yesterday, last week, or next month against that timestamp and answer with "
    "the resulting calendar date or period. Combine multiple memories when needed. "
    "Keep answers concise (typically 1-15 words).\n\n"
    "Memory context:\n{ctx}\n\n"
    "Question: {q}\n"
    "Answer:"
